...
class CustomTabsHelper {
    ...
    /** Checks if user has Chrome Installed */
    static boolean isChromeInstalled(String packageName)
    {
        return packageName.contains(STABLE_PACKAGE)
                || packageName.contains(BETA_PACKAGE)
                || packageName.contains(DEV_PACKAGE)
                || packageName.contains(LOCAL_PACKAGE);
    }
